...
pub fn parse_markdown(markdown_input: &str) -> RenderedPage {
    ...
    // Collect events to peek ahead for text
       ...
       while i < events.len() {
        ...
        // 2. CSS Requirement: Nested Sections
        ...
        // 3. CSS Requirement: data-parent-heading
        // If this is an H3, we add the last seen H2 text to it
    ...
    // 4. Render HTML
    // We wrap the specific H2/H3 in a section with ID for the IntersectionObserver
    if current_level > 0 {
